...
public:
	...
	///
	void searchForService(const QString& st = "urn:ambilightapp.blogspot.com:device:basic:1");
	...
	///
	QString getFirstService(const searchType& type = searchType::STY_WEBSERVER, const QString& st = "urn:ambilightapp.blogspot.com:device:basic:1", int timeout_ms = 3000);
