...
class AmbilightAppDaemon : public QObject
{
	Q_OBJECT
...
public slots:
	void instanceStateChangedHandler(ambilightapp::InstanceState state, quint8 instance, const QString& name = QString());
	void settingsChangedHandler(settings::type type, const QJsonDocument& config);
	void getInstanceManager(std::shared_ptr<AmbilightAppManager>& retVal);
