...
AmbilightAPI::AmbilightAPI(QString peerAddress, Logger* log, bool localConnection, QObject* parent, bool noListener)
	: CallbackAPI(log, localConnection, parent)
{
	...
	connect(_ledStreamTimer, &QTimer::timeout, this, &AmbilightAPI::handleLedColorsTimer, Qt::UniqueConnection);

	Q_INIT_RESOURCE(JSONRPC_schemas);
}

void AmbilightAPI::handleMessage(const QString& messageString, const QString& httpAuthHeader)
{
	try
	{
...
void AmbilightAPI::initialize()
{
	// init API, REQUIRED!
	BaseAPI::init();

	// setup auth interface
	connect(this, &BaseAPI::SignalPendingTokenClientNotification, this, &AmbilightAPI::newPendingTokenRequest);
	connect(this, &BaseAPI::SignalTokenClientNotification, this, &AmbilightAPI::handleTokenResponse);

	// listen for killed instances
	connect(_instanceManager.get(), &AmbilightAppManager::SignalInstanceStateChanged, this, &AmbilightAPI::handleInstanceStateChange);

	// pipe callbacks from subscriptions to parent
	connect(this, &CallbackAPI::SignalCallbackToClient, this, &AmbilightAPI::SignalCallbackJsonMessage);

	// notify ambilightapp about a jsonMessageForward
	if (_ambilightapp != nullptr)
		connect(this, &AmbilightAPI::SignalForwardJsonMessage, _ambilightapp.get(), &AmbilightAppInstance::SignalForwardJsonMessage);
}

bool AmbilightAPI::handleInstanceSwitch(quint8 inst, bool forced)
{
...
void AmbilightAPI::handleColorCommand(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleImageCommand(const QJsonObject& message, const QString& command, int tan)
{
	emit SignalForwardJsonMessage(message);
...
void AmbilightAPI::handleEffectCommand(const QJsonObject& message, const QString& command, int tan)
{
	emit SignalForwardJsonMessage(message);
...
ambilightapp::Components AmbilightAPI::getActiveComponent()
{
...
void AmbilightAPI::handleServerInfoCommand(const QJsonObject& message, const QString& command, int tan)
{
	try
	{
...
void AmbilightAPI::handleClearCommand(const QJsonObject& message, const QString& command, int tan)
{
	emit SignalForwardJsonMessage(message);
	int priority = message["priority"].toInt();
	QString replyMsg;
...
void AmbilightAPI::handleClearallCommand(const QJsonObject& message, const QString& command, int tan)
{
	emit SignalForwardJsonMessage(message);
	QString replyMsg;
...
void AmbilightAPI::handleHelpCommand(const QJsonObject& message, const QString& command, int tan)
{
	QJsonObject req;
...
void AmbilightAPI::handleCropCommand(const QJsonObject& message, const QString& command, int tan)
{
	GrabberWrapper* grabberWrapper = (_videoGrabber != nullptr) ? _videoGrabber->grabberWrapper() : nullptr;
...
void AmbilightAPI::handleBenchmarkCommand(const QJsonObject& message, const QString& command, int tan)
{
	GrabberWrapper* grabberWrapper = (_videoGrabber != nullptr) ? _videoGrabber->grabberWrapper() : nullptr;
...
void AmbilightAPI::lutDownloaded(QNetworkReply* reply, int hardware_brightness, int hardware_contrast, int hardware_saturation, qint64 time)
{
...
void AmbilightAPI::handleLutInstallCommand(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleCurrentStateCommand(const QJsonObject& message, const QString& command, int tan)
{
	const QString& subc = message["subcommand"].toString().trimmed();
...
void AmbilightAPI::handleSmoothingCommand(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleVideoControlsCommand(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleSourceSelectCommand(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleSaveDB(const QJsonObject& message, const QString& command, int tan)
{
	if (_adminAuthorized)
	{
		QJsonObject backup;
...
void AmbilightAPI::handleLoadDB(const QJsonObject& message, const QString& command, int tan)
{
	if (_adminAuthorized)
	{
		QString error;
...
void AmbilightAPI::handlePerformanceCounters(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleLoadSignalCalibration(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleConfigCommand(const QJsonObject& message, const QString& command, int tan)
{
	QString subcommand = message["subcommand"].toString("");
	QString full_command = command + "-" + subcommand;
...
void AmbilightAPI::handleConfigSetCommand(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleSchemaGetCommand(const QJsonObject& message, const QString& command, int tan)
{
	// create result
...
void AmbilightAPI::handleComponentStateCommand(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleIncomingColors(const std::vector<ColorRgb>& ledValues)
{
...
void AmbilightAPI::handleLedColorsTimer()
{
	emit streamLedcolorsUpdate(_currentLedValues);
}

void AmbilightAPI::handleLedColorsCommand(const QJsonObject& message, const QString& command, int tan)
{
	// create result
	QString subcommand = message["subcommand"].toString("");
...
void AmbilightAPI::handleLoggingCommand(const QJsonObject& message, const QString& command, int tan)
{
	// create result
	QString subcommand = message["subcommand"].toString("");
	...
	if (BaseAPI::isAdminAuthorized())
	{
		...
		if (subcommand == "start")
		{
			if (!_streaming_logging_activated)
			{
				...
				connect(_logsManager.get(), &LoggerManager::newLogMessage, this, &AmbilightAPI::incommingLogMessage);
		...
		else if (subcommand == "stop")
		{
			if (_streaming_logging_activated)
			{
				disconnect(_logsManager.get(), &LoggerManager::newLogMessage, this, &AmbilightAPI::incommingLogMessage);
				_streaming_logging_activated = false;
...
void AmbilightAPI::handleProcessingCommand(const QJsonObject& message, const QString& command, int tan)
{
	BaseAPI::setLedMappingType(ImageToLedManager::mappingTypeToInt(message["mappingType"].toString("multicolor_mean")));
	sendSuccessReply(command, tan);
}

void AmbilightAPI::handleVideoModeHdrCommand(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleLutCalibrationCommand(const QJsonObject& message, const QString& command, int tan)
{
	QString subcommand = message["subcommand"].toString("");
...
void AmbilightAPI::handleInstanceCommand(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleLedDeviceCommand(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::streamLedcolorsUpdate(const std::vector<ColorRgb>& ledColors)
{
	QJsonObject result;
	QJsonArray leds;
...
void AmbilightAPI::handlerInstanceImageUpdated(const Image<ColorRgb>& image)
{
	_liveImage = image;
	QUEUE_CALL_0(this, sendImage);
}

void AmbilightAPI::sendImage()
{
...
void AmbilightAPI::incommingLogMessage(const Logger::T_LOG_MESSAGE& msg)
{
...
void AmbilightAPI::newPendingTokenRequest(const QString& id, const QString& comment)
{
	QJsonObject obj;
	obj["comment"] = comment;
	obj["id"] = id;
...
void AmbilightAPI::handleTokenResponse(bool success, const QString& token, const QString& comment, const QString& id, const int& tan)
{
...
void AmbilightAPI::handleInstanceStateChange(InstanceState state, quint8 instance, const QString& name)
{
	switch (state)
	{
...
void AmbilightAPI::stopDataConnections()
{
...
void AmbilightAPI::handleTunnel(const QJsonObject& message, const QString& command, int tan)
{
...
bool AmbilightAPI::isLocal(QString hostname)
{
...
void AmbilightAPI::handleSysInfoCommand(const QJsonObject&, const QString& command, int tan)
{
	// create result
	QJsonObject result;
	QJsonObject info;
...
void AmbilightAPI::handleAdjustmentCommand(const QJsonObject& message, const QString& command, int tan)
{
...
void AmbilightAPI::handleAuthorizeCommand(const QJsonObject& message, const QString& command, int tan)
{
	const QString& subc = message["subcommand"].toString().trimmed();
...
void AmbilightAPI::handleNotImplemented(const QString& command, int tan)
{
	sendErrorReply("Command not implemented", command, tan);
}

void AmbilightAPI::sendSuccessReply(const QString& command, int tan)
{
	// create reply
	QJsonObject reply;
	reply["success"] = true;
...
void AmbilightAPI::sendSuccessDataReply(const QJsonDocument& doc, const QString& command, int tan)
{
	QJsonObject reply;
	reply["success"] = true;
	reply["command"] = command;
...
void AmbilightAPI::sendErrorReply(const QString& error, const QString& command, int tan)
{
	// create reply
	QJsonObject reply;
	reply["success"] = false;
