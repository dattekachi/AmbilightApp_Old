...
///
/// Connection class to setup an connection to the ambilightapp server and execute commands
///
...
public:
	...
	/// Constructor
	///
	/// @param address The address of the Ambilight App server (for example "192.168.0.32:19444)
	...
	///
	/// Print the current loaded Ambilight App configuration file
	///
