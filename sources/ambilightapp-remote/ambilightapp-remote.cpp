...
int getInstaneIdbyName(const QJsonObject& reply, const QString& name) {
	...
	std::cout << "Can't find a running instance with name '" << name.toStdString() << "' at this Ambilight App server, will use first instance" << std::endl;
	return 0;
}
...
int main(int argc, char* argv[])
{
	...
	try
	{
		...
		Parser parser("Application to send a command to ambilightapp using the JSON interface");

		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//      art             variable definition       append art to Parser     short-, long option              description, optional default value      //
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		Option&           argAddress            = parser.add<Option>       ('a', "address"                , "Set the address of the ambilightapp server [default: %1]", "127.0.0.1:19444");
		...
		BooleanOption&    argOff                = parser.add<BooleanOption>(0x0, "off"                    , "Deactivates ambilightapp");
		BooleanOption&    argOn                 = parser.add<BooleanOption>(0x0, "on"                     , "Activates ambilightapp");
		BooleanOption&    argConfigGet          = parser.add<BooleanOption>(0x0, "configGet"              , "Print the current loaded Ambilight App configuration file");
		BooleanOption&    argSchemaGet          = parser.add<BooleanOption>(0x0, "schemaGet"              , "Print the JSON schema for Ambilight App configuration");
		...
		// create the connection to the ambilightapp server
		...
		// If a specific Ambilight App instance is given, set it
